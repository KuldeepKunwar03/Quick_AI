...
import { t as require_client } from "./client-BmDGWX6b.js";
...
var HOOK_NAME$5 = "useOAuthConsent";
/**
...
var HOOK_NAME$4 = "useOAuthDeviceVerification";
var normalizeUserCode = (userCode) => userCode.toUpperCase().replace(/[-\p{White_Space}]/gu, "");
var createNotReadyError = () => new ClerkRuntimeError("Clerk must be loaded before using OAuth device verification.", { code: "oauth_device_verification_not_ready" });
var createLookupInProgressError = () => new ClerkRuntimeError("An OAuth device verification lookup is already in progress for another code.", { code: "oauth_device_verification_lookup_in_progress" });
var createSubmissionInProgressError = () => new ClerkRuntimeError("Another OAuth device verification decision is already in progress.", { code: "oauth_device_verification_submission_in_progress" });
/**
...
function useOAuthDeviceVerification() {
	...
	const pendingLookup = (0, import_react.useRef)(null);
	const pendingSubmit = (0, import_react.useRef)(null);
	const generation = (0, import_react.useRef)(0);
	clerk.telemetry?.record(eventMethodCalled(HOOK_NAME$4));
	const lookup = (0, import_react.useCallback)((params) => {
	...
	const submit = (0, import_react.useCallback)((params, approved) => {
		const oauthApplication = clerk.loaded ? clerk.oauthApplication : void 0;
		if (!oauthApplication) return Promise.reject(createNotReadyError());
	...
	return {
		...
		isSubmitting,
		lookup,
		approve: (0, import_react.useCallback)((params) => submit(params, true), [submit]),
		deny: (0, import_react.useCallback)((params) => submit(params, false), [submit]),
...
* ```
*/
var OAuthDeviceVerification = withClerk(({ clerk, component, fallback, ...props }) => {
	const shouldShowFallback = useWaitForComponentMount(component) === "rendering" || !clerk.loaded;
	const rendererRootProps = { ...shouldShowFallback && fallback && { style: { display: "none" } } };
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ import_react.createElement(ClerkHostRenderer, {
		component,
...
*/
var versionSelector = (clerkJSVersion, packageVersion = "6.31.0") => {
